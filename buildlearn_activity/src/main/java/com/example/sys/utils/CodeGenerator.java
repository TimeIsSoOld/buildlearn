...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("yjn");//作者，开发人员
        gc.setOpen(true); // 是否打开生成的目录
        ...
        dsc.setUrl("jdbc:mysql://43.154.195.135:3306/db?serverTimezone=GMT");//驱动连接的URL
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");//驱动名称
        dsc.setUsername("yjn");//数据库连接用户名
        ...
        pc.setParent("com.example.sys"); // 生成的代码的父路径
        ...
        strategy.setInclude("teacher_info","object_info"); // 要生成的表在数据库中的名称, 每张表名以英文逗号隔开
